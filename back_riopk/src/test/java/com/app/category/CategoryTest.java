...
public class CategoryTest {
    ...
    @BeforeEach
    void setUp() {
        categories.add(new Category(1L, "name1"));
        categories.add(new Category(2L, "name2"));
        categories.add(new Category(3L, "name3"));
        categories.add(new Category(4L, "name4"));
    }
    ...
    void testUpdateSuccess() {
        ...
        Category update = new Category("update name");
